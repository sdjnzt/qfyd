...
const alarmList = ref<AlarmItem[]>([
  { id: 1, level: '严重', content: '教学资源存储空间使用率达到88%，请及时清理', source: '存储监控', time: '2025-06-10 14:25:30', status: '未处理', detail: '存储设备"教学资源存储"剩余空间不足3TB，可能影响系统正常运行。', suggestion: '清理临时文件和过期数据，或者扩容存储设备。' },
  { id: 2, level: '警告', content: '教学楼交换机A带宽使用率超过85%，可能影响网络访问速度', source: '网络监控', time: '2025-06-10 13:45:12', status: '未处理', detail: '教学楼交换机A上行链路带宽使用率持续15分钟超过85%，下行链路正常。', suggestion: '检查是否有大量数据上传任务，必要时增加带宽或分流业务。' },
  { id: 3, level: '警告', content: '资源管理系统响应时间超过2秒，建议检查系统负载', source: '应用监控', time: '2025-06-10 13:20:05', status: '已处理', detail: '资源管理系统平均响应时间为2.5秒，超过警告阈值2秒。', suggestion: '检查系统负载情况，必要时进行资源扩容或优化SQL查询。', processor: '张工', processTime: '2025-06-10 14:30:15', processNote: '已重启应用服务，恢复正常' },
  { id: 4, level: '提示', content: '服务器计划性维护将于今晚23:00进行，预计持续2小时', source: '系统通知', time: '2025-06-10 12:10:56', status: '未处理', detail: '计划对主要服务器进行系统更新和安全补丁安装，预计维护时间为23:00-01:00。', suggestion: '请相关人员提前做好数据备份和应用下线准备。' },
  { id: 5, level: '严重', content: '资源管理服务器CPU使用率持续超过85%，建议立即检查', source: '服务器监控', time: '2025-06-10 11:50:23', status: '未处理', detail: '服务器"资源管理服务器"CPU使用率持续30分钟超过85%，内存使用率75%。', suggestion: '检查是否有异常进程占用资源，必要时重启服务或增加资源配置。' },
  { id: 6, level: '警告', content: '学生管理系统数据库连接池接近饱和，当前使用率92%', source: '应用监控', time: '2025-06-10 10:15:42', status: '已处理', detail: '学生管理系统数据库连接池最大连接数100，当前已使用92个连接。', suggestion: '检查是否存在连接泄漏，或增加连接池最大连接数。', processor: '李工', processTime: '2025-06-10 10:45:20', processNote: '已优化连接池配置，释放空闲连接' },
  { id: 7, level: '严重', content: '主防火墙检测到疑似DDoS攻击，已触发自动防护', source: '安全监控', time: '2025-06-10 09:30:15', status: '未处理', detail: '主防火墙检测到大量SYN请求，IP来源分散，疑似DDoS攻击。', suggestion: '检查网络流量情况，必要时联系网络服务提供商增加防护措施。' },
  { id: 8, level: '提示', content: '系统备份任务已完成，备份大小25GB', source: '备份系统', time: '2025-06-10 08:00:00', status: '已处理', detail: '每日系统备份任务正常完成，备份文件已存储至备份存储设备。', suggestion: '定期检查备份文件完整性，并进行恢复测试。', processor: '系统自动', processTime: '2025-06-10 08:00:05', processNote: '自动完成' },
  { id: 9, level: '警告', content: '存储系统RAID降级，硬盘3疑似故障', source: '存储监控', time: '2025-06-09 22:10:35', status: '未处理', detail: 'RAID5阵列中硬盘3读取错误率增加，可能即将故障。', suggestion: '尽快替换可能故障的硬盘，避免数据丢失。' },
  { id: 10, level: '警告', content: '备份存储B使用率达到73%，超过预警阈值', source: '存储监控', time: '2025-06-09 20:45:12', status: '未处理', detail: '备份存储B总容量30TB，已使用22TB，使用率73%。', suggestion: '清理过期备份数据，或规划存储扩容。' },
  { id: 11, level: '提示', content: '系统自动更新已完成，所有安全补丁已安装', source: '系统通知', time: '2025-06-09 18:30:00', status: '已处理', detail: '系统自动更新包含10个安全补丁和5个功能更新。', suggestion: '无需操作，系统已处于最新状态。', processor: '系统自动', processTime: '2025-06-09 18:30:10', processNote: '自动完成' },
  { id: 12, level: '严重', content: '数据库主从同步中断，需要手动干预', source: '数据库监控', time: '2025-06-09 16:20:45', status: '已处理', detail: '主从数据库同步延迟超过30分钟，可能存在数据不一致。', suggestion: '检查主从同步状态，修复同步问题，必要时重建从库。', processor: '王工', processTime: '2025-06-09 17:15:30', processNote: '已修复主从同步配置，恢复正常' },
  { id: 13, level: '警告', content: '无线AP-3F离线，可能影响教学楼3楼网络使用', source: '网络监控', time: '2025-06-09 15:10:22', status: '未处理', detail: '无线AP-3F已离线超过10分钟，Ping不通。', suggestion: '检查设备电源和网络连接，必要时重启或更换设备。' },
  { id: 14, level: '警告', content: '系统日志空间不足，当前剩余10%', source: '系统监控', time: '2025-06-09 14:05:18', status: '未处理', detail: '系统日志分区总容量50GB，剩余5GB，即将耗尽。', suggestion: '清理过期日志文件，或增加日志分区容量。' },
  { id: 15, level: '提示', content: '新版本教务管理系统已发布，可以升级', source: '系统通知', time: '2025-06-09 12:00:00', status: '未处理', detail: '教务管理系统v2.5已发布，包含新功能和bug修复。', suggestion: '在维护时间窗口进行系统升级，升级前请备份数据。' }
])
